<%-- 
    Document   : index
    Created on : Jan 25, 2019, 11:49:46 AM
    Author     : James
--%>
					...
					<div class="col-md-10 text-right menu-1">
						<ul>
							...
							<li class="has-dropdown">
								<a class="btn-cta">Login</a>
								<ul class="dropdown">
									<li><a href="adminlogin.jsp">admin</a></li>
									<li><a href="jailog.jsp">People </a></li>
									
								</ul>
							</li>
                                                       <li class="has-dropdown">
								<a class="btn-cta">Registration</a>
								<ul class="dropdown">
									<li><a href="register.jsp">People Register</a></li>
							...
							<li><a href="index.jsp">Contact</a></li>
                                            ...
                                            <div>
    <form action="mailto:prabu.mk@pantechmail.com" method="GET">

   
<button onclick="getLocation()" subject="im in critical condition">SOS</button>
</form>
