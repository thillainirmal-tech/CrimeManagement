...
insert  into `newregister`(`poid`,`username`,`password`,`gender`,`stat`,`email`,`phno`,`otp1`) values ('NjAwNQ==','varshini1','varshini','Female','B1 Station','bhavani.varshini97@gmail.com','987654321','JlqWNt');
