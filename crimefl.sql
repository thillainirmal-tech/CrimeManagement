...
insert  into `crecd`(`firno`,`cname`,`cage`,`cadd`,`cdate`,`crime`,`filename`,`status`) values (1,'as','23','sds',NULL,NULL,'img89.png','Approved'),(2,'as','23','sds',NULL,NULL,'image1.png','Approved'),(3,'a','1','as',NULL,NULL,'Dataset.xlsx','Pending'),(4,'a','1','as',NULL,NULL,'CSE 2019.xlsx','Pending'),(5,'sekar','12','26,2nd floor,kota sreenivasaya charities ramanuja kudam building,T.nagar,chennai 6000 017 tamil nadu',NULL,NULL,'A Secure Data Forwarding In Multiple.docx','Approved'),(6,'a','23','asd',NULL,NULL,'Enabling identity-based integrity auditing and data sharing with sensitive information hiding for secure cloud storage.docx','Pending'),(7,'aa','22','asd',NULL,NULL,'Enabling identity-based integrity auditing and data sharing with sensitive information hiding for secure cloud storage.docx','Pending'),(8,'asdf','23','chennai',NULL,NULL,'Enabling identity-based integrity auditing and data sharing with sensitive information hiding for secure cloud storage.docx','Approved'),(9,'anbu','23','saidapet','2019-02-24','Murder','software & hardware specification.docx','Pending');
...
insert  into `newregister`(`poid`,`username`,`password`,`gender`,`stat`,`email`,`phno`,`otp1`) values ('NjAwNQ==','varshini1','varshini','Female','B1 Station','bhavani.varshini97@gmail.com','987654321','cnWjMB');
