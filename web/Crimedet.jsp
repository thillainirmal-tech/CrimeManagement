...
.button:hover span:after {
  ...
  right: 0;
	...
	<body align="center">
             <form name="formm" action="Crimedet.jsp" method="POST" onsubmit="return one()">
		<div class="container">
			<!-- Top Navigation -->
    ...
    <nav class="codrops-demos">
        <a>Enter Crime Place:  <input type="text" name="stdrg" value=""/></a>&nbsp;&nbsp;&nbsp;&nbsp;<br><br>
<!--      <a>Book Name  :  <input type="text" name="bknm" value=""/></a>&nbsp;&nbsp;&nbsp;&nbsp;<br><br>-->
        <button class="button" type="submit" name="Student Status" style="vertical-align:middle"><span>Crime Status </span></button>
<!--        <button class="button" type="submit" name="Book Search" style="vertical-align:middle" onclick="form.action='SerBk.jsp';"><span>Book Search </span></button>-->
			...
			<div class="component">
				...
				<table>
                    ...
                    String query="SELECT * FROM crecd WHERE cadd='"+d1+"' ";
