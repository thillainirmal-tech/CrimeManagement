...
.button:hover span:after {
  ...
  right: 0;
	...
	<body align="center">
            <form name="formm" action="DetWtCrmNm.jsp" method="POST" onsubmit="return one()">
		<div class="container">
			<!-- Top Navigation -->
    ...
    <nav class="codrops-demos">
        <a>Enter Crime Name:  <input type="text" name="stdrg" value=""/></a>&nbsp;&nbsp;&nbsp;&nbsp;<br><br>
...
<!--        <button class="button" type="submit" name="Book Search" style="vertical-align:middle" onclick="form.action='SerBk.jsp';"><span>Book Search </span></button>-->
			...
			<div class="component">
				...
				<table>
                    ...
                    String query="SELECT * FROM crecd WHERE crime='"+d1+"' ";
